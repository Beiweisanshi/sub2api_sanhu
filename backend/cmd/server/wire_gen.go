...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	telemetryHandler := handler.NewTelemetryHandler(telemetryRewriterService, claudeTokenProvider, accountRepository, httpUpstream, configConfig)
	idempotencyCoordinator := service.ProvideIdempotencyCoordinator(idempotencyRepository, configConfig)
	idempotencyCleanupService := service.ProvideIdempotencyCleanupService(idempotencyRepository, configConfig)
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, telemetryHandler, idempotencyCoordinator, idempotencyCleanupService)
