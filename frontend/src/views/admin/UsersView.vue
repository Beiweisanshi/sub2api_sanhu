...
<template>
 ...
 class="absolute right-0 top-full z-50 mt-1 max-h-80 w-48 overflow-y-auto rounded-lg border border-gray-200 bg-white py-1 shadow-lg"
 >
 <button
 ...
 >
 <Icon name="shield" size="xs" class="h-3.5 w-3.5 text-gray-500" />
 <span class="font-medium text-gray-600">{{ getUserGroups(row).exclusive.length }}</span>
 ...
 <div
 v-if="expandedGroupUserId === row.id"
 class="absolute left-0 top-full z-50 mt-1.5 min-w-[160px] overflow-hidden rounded-lg border border-gray-200 bg-white py-1 text-xs shadow-xl"
 >
 ...
 class="rounded px-2 py-0.5 text-xs font-medium text-primary-600 transition-colors hover:bg-primary-50"
 ...
 class="action-menu-content fixed z-[9999] w-48 overflow-hidden rounded-xl bg-white shadow-lg ring-1 ring-black/5"
