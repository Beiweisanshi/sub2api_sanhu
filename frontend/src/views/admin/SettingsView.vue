    ...
    <div class="mx-auto max-w-4xl space-y-6">
      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
        ...
        <div v-show="activeTab === 'gateway'" class="space-y-6">
          ...
          >
            <div
              class="mx-4 w-full max-w-lg rounded-xl bg-white p-6 shadow-xl"
            >
              <h3
            ...
            >
              ...
              <p class="mt-1 text-sm text-gray-500">
                ...
                <a
                  ...
                  class="ml-2 inline-flex items-center text-primary-600 hover:text-primary-700"
                >
                  <svg
              ...
              <template v-if="form.payment_enabled">
                ...
                <div class="grid grid-cols-3 gap-3">
                  ...
                  <div>
                    ...
                    >
                      {{
                        (form.payment_product_name_prefix || "芝麻 ZHIMA") +
                        " 100 " +
                ...
                <div>
                  ...
                  <p class="mt-2 text-xs text-gray-400">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      class="ml-1 text-primary-500 hover:text-primary-600"
                    >
