...
<template>
 ...
 class="flex items-center gap-2 rounded-lg bg-gradient-to-r from-primary-50 to-primary-50 px-3 py-2"
 >
 ...
 <!-- Tip -->
 <div class="rounded-lg bg-primary-50 p-3 text-xs text-primary-700">
...
.reset-info {
 @apply flex items-center gap-1 pl-12 text-[10px] text-primary-600 ;
}
</style>
