...
<template>
 ...
 <div v-else-if="sortedRules.length === 0" class="rounded-xl border border-dashed border-gray-200 p-8 text-center text-sm text-gray-500">
 {{ t('admin.ops.alertRules.empty') }}
 </div>

 <div v-else class="max-h-[520px] overflow-hidden rounded-xl border border-gray-200">
 ...
 >
 <div class="space-y-4">
 <div v-if="!editorValidation.valid" class="rounded-xl bg-red-50 p-4 text-xs text-red-700">
 ...
 <div class="flex items-center justify-between rounded-xl bg-gray-50 px-4 py-3 md:col-span-2">
