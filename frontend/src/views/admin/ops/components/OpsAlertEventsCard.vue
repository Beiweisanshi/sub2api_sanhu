...
function severityBadgeClass(severity: string | undefined): string {
 ...
 if (s === 'p2' || s === 'info') return 'bg-primary-100 text-primary-700 '
...
function statusBadgeClass(status: string | undefined): string {
 ...
 if (s === 'resolved') return 'bg-primary-50 text-primary-700 ring-primary-600/20 '
 if (s === 'manual_resolved') return 'bg-gray-50 text-gray-700 ring-gray-600/20 '
...
<template>
 ...
 <div v-else-if="empty" class="rounded-xl border border-dashed border-gray-200 p-8 text-center text-sm text-gray-500">
