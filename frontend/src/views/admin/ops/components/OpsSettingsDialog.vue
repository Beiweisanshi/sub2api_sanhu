...
<template>
 ...
 :key="email"
 class="inline-flex items-center gap-2 rounded-full bg-primary-100 px-3 py-1 text-xs font-medium text-primary-700"
 >
 {{ email }}
 ...
 <!-- 高级设置 -->
 <details class="rounded-2xl bg-gray-50">
 ...
 <div class="flex items-center justify-between">
 <div>
 <label class="text-sm font-medium text-gray-700">{{ t('admin.ops.settings.ignoreInvalidApiKeyErrors') }}</label>
 <p class="mt-1 text-xs text-gray-500">
