...
<template>
 ...
 class="absolute right-0 z-50 mt-2 w-56 origin-top-right rounded-lg border border-gray-200 bg-white shadow-lg"
 >
 <div class="p-2">
 <button
 ...
 <PlatformTypeBadge :platform="row.platform" :type="row.type" :plan-type="row.credentials?.plan_type" :privacy-mode="row.extra?.privacy_mode" :subscription-error="row.credentials?.subscription_error" :subscription-expires-at="row.credentials?.subscription_expires_at" />
 <span
...
function getAntigravityTierClass(row: any): string {
 ...
 case 'g1-pro-tier': return 'bg-primary-100 text-primary-600 '
 case 'g1-ultra-tier': return 'bg-gray-100 text-gray-600 '
 default: return ''
 }
}
