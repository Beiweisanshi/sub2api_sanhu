...
<template>
 ...
 <div class="relative">
 <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
 <Icon name="key" size="md" :class="invitationValidation.valid ? 'text-primary-500' : 'text-gray-400 '" />
 </div>
 <input
 id="invitation_code"
 ...
 :class="{
 'border-primary-500 focus:border-primary-500 focus:ring-primary-500': invitationValidation.valid,
 ...
 <Icon name="checkCircle" size="md" class="text-primary-500" />
 </div>
 ...
 <div v-if="invitationValidation.valid" class="mt-2 flex items-center gap-2 rounded-lg bg-primary-50 px-3 py-2">
 <Icon name="checkCircle" size="sm" class="text-primary-600" />
 ...
 <div class="relative">
 <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
 <Icon name="gift" size="md" :class="promoValidation.valid ? 'text-primary-500' : 'text-gray-400 '" />
 </div>
 <input
 id="promo_code"
 ...
 class="input pl-11 pr-10"
 :class="{
 'border-primary-500 focus:border-primary-500 focus:ring-primary-500': promoValidation.valid,
 ...
 <transition name="fade">
 <div v-if="promoValidation.valid" class="mt-2 flex items-center gap-2 rounded-lg bg-primary-50 px-3 py-2">
 <Icon name="gift" size="sm" class="text-primary-600" />
 <span class="text-sm text-primary-700">
...
const siteName = ref<string>('芝麻 ZHIMA')
...
onMounted(async () => {
 ...
 siteName.value = settings.site_name || '芝麻 ZHIMA'
