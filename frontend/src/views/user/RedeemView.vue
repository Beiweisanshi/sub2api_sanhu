...
<template>
 ...
 <div
 class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-primary-100"
 >
 <Icon name="checkCircle" size="md" class="text-primary-600" />
 </div>
 <div class="flex-1">
 ...
 <div
 class="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gray-100"
 >
