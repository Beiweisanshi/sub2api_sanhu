...
<template>
 <div class="flex min-h-screen items-center justify-center bg-claude-bg p-4">
 <div
 class="w-full max-w-md space-y-4 rounded-2xl border border-claude-border bg-white p-6 shadow-lg"
 >
 <!-- Amount + Order ID -->
 ...
 <div class="text-5xl text-primary-600">✓</div>
