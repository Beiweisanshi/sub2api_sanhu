...
<template>
 ...
 <div v-if="tabs.length > 1 && paymentPhase === 'select' && !selectedPlan" class="flex space-x-1 rounded-xl bg-gray-100 p-1">
 ...
 <p class="mt-0.5 text-sm font-medium text-primary-600">{{ t('payment.currentBalance') }}: {{ user?.balance?.toFixed(2) || '0.00' }}</p>
 </div>
 ...
 <span class="text-gray-900">¥{{ validAmount.toFixed(2) }}</span>
 </div>
 <div v-if="feeRate > 0" class="flex justify-between">
 <span class="text-gray-500">{{ t('payment.fee') }} ({{ feeRate }}%)</span>
 <span class="text-gray-900">¥{{ feeAmount.toFixed(2) }}</span>
 </div>
 ...
 <span class="text-lg font-bold text-primary-600">¥{{ totalAmount.toFixed(2) }}</span>
 </div>
 ...
 <div v-if="errorMessage" class="rounded-xl border border-red-200 bg-red-50 p-4">
 ...
 <span class="text-gray-900">¥{{ selectedPlan.price.toFixed(2) }}</span>
 </div>
 <div class="flex justify-between">
 <span class="text-gray-500">{{ t('payment.fee') }} ({{ feeRate }}%)</span>
 <span class="text-gray-900">¥{{ subFeeAmount.toFixed(2) }}</span>
 </div>
 <div class="flex justify-between border-t border-gray-200 pt-2">
 <span class="font-medium text-gray-700">{{ t('payment.actualPay') }}</span>
 <span class="text-lg font-bold text-primary-600">¥{{ subTotalAmount.toFixed(2) }}</span>
 </div>
 </div>
 </div>
 ...
 class="flex items-center gap-3 rounded-xl border border-gray-100 bg-white px-3 py-2">
 <div :class="['h-6 w-1 shrink-0 rounded-full', platformAccentBarClass(sub.group?.platform || '')]" />
 <div class="min-w-0 flex-1">
 <div class="flex items-center gap-1.5">
 <span class="truncate text-xs font-semibold text-gray-900">{{ sub.group?.name || `Group #${sub.group_id}` }}</span>
 ...
 <div class="relative w-full max-w-lg rounded-2xl border border-gray-200 bg-white p-6 shadow-2xl">
 <!-- Close button -->
