...
<template>
 ...
 <Icon name="document" size="md" class="text-primary-600" />
 </div>
 <div>
 ...
 <Icon name="cube" size="md" class="text-amber-600" />
 </div>
 <div>
 <p class="text-xs font-medium text-gray-500">
 {{ t('usage.totalTokens') }}
 ...
 <div class="flex items-center gap-3">
 <div class="rounded-lg bg-primary-100 p-2">
 <Icon name="dollar" size="md" class="text-primary-600" />
 </div>
 ...
 <Icon name="clock" size="md" class="text-gray-600" />
 </div>
 <div>
 <p class="text-xs font-medium text-gray-500">
 {{ t('usage.avgDuration') }}
 ...
 <!-- Output -->
 <div class="inline-flex items-center gap-1">
 <Icon name="arrowUp" size="sm" class="text-gray-500" />
 <span class="font-medium text-gray-900">{{
 ...
 >
 <div
 class="flex h-4 w-4 cursor-help items-center justify-center rounded-full bg-gray-100 transition-colors group-hover:bg-primary-100"
 >
 <Icon
 name="infoCircle"
 size="xs"
 ...
 >
 <div
 class="whitespace-nowrap rounded-lg border border-gray-700 bg-gray-900 px-3 py-2.5 text-xs text-white shadow-xl"
 >
