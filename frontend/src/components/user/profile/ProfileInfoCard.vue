          ...
          <div class="min-w-0 flex-1 space-y-5">
            ...
            <div class="grid gap-3 sm:grid-cols-3">
              <div
                ...
                class="rounded-2xl bg-white/85 px-4 py-3 shadow-sm ring-1 ring-white/70"
              >
      ...
      <div data-testid="profile-main-column" class="space-y-6">
        ...
        >
          ...
          <div class="grid gap-6 sm:grid-cols-1 md:grid-cols-2">
            <div class="rounded-3xl border border-gray-100 bg-gray-50/80 p-5">
              <ProfileAvatarCard
                :user="user"
                embedded
              />
        ...
        >
          ...
          <div class="mt-5 grid gap-3">
            <div
              v-for="hint in sourceHints"
              :key="hint.key"
              class="flex items-start gap-3 rounded-2xl border border-gray-100 bg-gray-50/80 px-4 py-3 text-sm text-gray-600"
            >
