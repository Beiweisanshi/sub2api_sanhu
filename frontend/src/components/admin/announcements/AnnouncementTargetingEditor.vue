...
<template>
 ...
 <div v-if="anyOf.length === 0" class="rounded-xl border border-dashed border-gray-300 p-4 text-sm text-gray-500">
 ...
 <div v-if="validationError" class="rounded-xl border border-red-200 bg-red-50 p-3 text-sm text-red-700">
 {{ validationError }}
 </div>
 </div>
 </div>
