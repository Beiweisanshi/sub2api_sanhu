...
<template>
 ...
 <div
 v-if="account"
 class="flex items-center justify-between rounded-xl border border-primary-200 bg-gradient-to-r from-primary-50 to-primary-100 p-3"
 >
 ...
 <!-- 30-Day Total Cost -->
 <div
 class="card border-primary-200 bg-gradient-to-br from-primary-50 to-white p-4"
 >
 ...
 <Icon name="dollar" size="sm" class="text-primary-600" />
 </div>
 </div>
 ...
 <Icon name="bolt" size="sm" class="text-amber-600" />
 </div>
 </div>
 <p class="text-2xl font-bold text-gray-900">
 ...
 <div
 class="card border-gray-300 bg-gradient-to-br from-gray-50 to-white p-4"
 >
 <div class="mb-2 flex items-center justify-between">
 <span class="text-xs font-medium text-gray-500">{{
 ...
 <div class="rounded-lg bg-primary-100 p-1.5">
 <Icon name="clock" size="sm" class="text-primary-600" />
 </div>
 ...
 <div class="mb-3 flex items-center gap-2">
 <div class="rounded-lg bg-orange-100 p-1.5">
 <Icon name="bolt" size="sm" class="text-orange-600" />
 </div>
 <span class="text-sm font-semibold text-gray-900">{{
...
const trendChartData = computed(() => {
 ...
 backgroundColor: chartColors.value.actualFill,
 fill: true,
 tension: 0.3,
 yAxisID: 'y'
 },
 ...
 borderColor: chartColors.value.user,
 backgroundColor: chartColors.value.userFill,
 fill: false,
 tension: 0.3,
 borderDash: [5, 5],
 yAxisID: 'y'
 ...
 backgroundColor: chartColors.value.requestsFill,
 fill: false,
 tension: 0.3,
 yAxisID: 'y1'
 }
...
const lineChartOptions = computed(() => ({
 ...
 ticks: {
 color: chartColors.value.actual,
 font: {
 size: 10
 },
