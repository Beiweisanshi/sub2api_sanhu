...
<template>
 ...
 class="rounded-xl border border-dashed border-gray-300 py-10 text-center"
 >
 ...
 v-for="plan in plans"
 :key="plan.id"
 class="rounded-xl border border-gray-200 bg-white transition-all"
 >
 <!-- Plan Header -->
 <div
 ...
 class="rounded-lg p-1.5 text-gray-400 transition-colors hover:bg-primary-50 hover:text-primary-500"
 ...
 class="border-t border-primary-100 bg-primary-50/50 px-4 py-3"
 @click.stop
 >
