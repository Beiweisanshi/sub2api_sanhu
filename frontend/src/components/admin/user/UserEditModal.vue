...
<template>
 ...
 <button v-if="form.password" type="button" @click="copyPassword" class="absolute right-2 top-1/2 -translate-y-1/2 rounded-lg p-1 transition-colors hover:bg-gray-100" :class="passwordCopied ? 'text-primary-500' : 'text-gray-400'">
