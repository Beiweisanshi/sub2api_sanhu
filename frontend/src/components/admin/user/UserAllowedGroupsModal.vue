...
<template>
 ...
 :key="config.groupId"
 class="relative overflow-hidden rounded-xl border-2 border-primary-200 bg-primary-50/50 p-4"
 >
 <div class="flex items-center gap-4">
 <!-- 复选框（禁用状态） -->
 <div class="flex-shrink-0">
 <div class="flex h-5 w-5 items-center justify-center rounded-md border-2 border-primary-400 bg-primary-500">
