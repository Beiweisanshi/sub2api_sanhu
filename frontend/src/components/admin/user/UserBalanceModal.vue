...
<template>
 ...
 <div v-if="form.amount > 0" class="rounded-xl border border-primary-200 bg-primary-50 p-4"><div class="flex items-center justify-between text-sm"><span class="text-gray-700">{{ t('admin.users.newBalance') }}:</span><span class="font-bold text-gray-900">${{ formatBalance(calculateNewBalance()) }}</span></div></div>
 </form>
 <template #footer>
