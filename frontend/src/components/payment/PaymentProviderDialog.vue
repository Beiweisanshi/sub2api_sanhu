...
<template>
 ...
 <!-- Stripe webhook hint -->
 <div v-if="stripeWebhookUrl" class="mt-3 rounded-lg border border-primary-200 bg-primary-50 p-3">
 <p class="text-xs text-primary-700">
 {{ t('admin.settings.payment.stripeWebhookHint') }}
 </p>
 <code class="mt-1 block break-all rounded bg-primary-100 px-2 py-1 text-xs text-primary-800">
 {{ stripeWebhookUrl }}
 </code>
 </div>
 </div>
