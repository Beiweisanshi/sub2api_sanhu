...
<template>
 ...
 <div :class="[
 'rounded-md p-1.5',
 provider.enabled && enabled ? 'bg-primary-100 ' : 'bg-gray-100 ',
 ]">
 <Icon
 name="server"
 size="sm"
 :class="provider.enabled && enabled ? 'text-primary-600 ' : 'text-gray-400'"
 />
 </div>
 ...
 <button type="button" @click="emit('edit')" class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-gray-500 transition-colors hover:bg-primary-50 hover:text-primary-600">
