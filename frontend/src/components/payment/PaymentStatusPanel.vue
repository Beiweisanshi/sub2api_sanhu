<!-- 作者：mkx | 日期：2026-04-22 | 变更：方案 A 配色优化 - 支付成功图标恢复 emerald -->
<template>
 <div class="space-y-4">
 ...
 <div v-if="paidOrder" class="w-full rounded-xl bg-gray-50 p-4">
...
const qrBorderClass = computed(() => {
 if (isAlipay.value) return 'border-[#00AEEF] bg-primary-50 '
 if (isWxpay.value) return 'border-[#2BB741] bg-primary-50 '
