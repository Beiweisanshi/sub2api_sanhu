<!-- 作者：mkx | 日期：2026-04-21 | 变更：调整侧栏为 Claude 暖色主题并移除暗色切换入口 -->
<template>
 <aside
 class="sidebar"
 :class="[
 ...
 <!-- Bottom Section -->
 <div class="mt-auto border-t border-claude-border p-3">
 <!-- Collapse Button -->
 <button
 @click="toggleSidebar"
  ...
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/groups', label: t('nav.groups'), icon: FolderIcon, hideInSimpleMode: true },
    {
      ...
      children: [
        ...
        { path: '/admin/model-pricing', label: t('nav.modelPricing'), icon: PricingIcon },
...
.sidebar-logo {
 flex: 0 0 2.25rem;
 min-width: 2.25rem;
 border: 1px solid rgb(232 229 223 / 0.9);
