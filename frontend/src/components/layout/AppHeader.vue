<!-- 作者：mkx | 日期：2026-04-21 | 变更：将应用头部调整为 Claude 暖色导航风格并补充品牌展示 -->
<template>
 <header class="sticky top-0 z-30 border-b border-claude-border bg-claude-card/90 backdrop-blur-xl">
 ...
 <router-link to="/home" class="flex items-center gap-3 lg:hidden">
 <div
 class="flex h-9 w-9 items-center justify-center overflow-hidden rounded-xl border border-claude-border bg-primary-50 text-sm font-semibold text-primary-500 shadow-sm"
 >
 <img
 v-if="siteLogo"
 :src="siteLogo"
 ...
 <p v-if="pageDescription" class="text-xs text-gray-500">
 {{ pageDescription }}
 </p>
 </div>
 </div>
 ...
 class="flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-sm font-medium text-gray-600 transition-colors hover:bg-gray-100 hover:text-claude-text"
 >
 <Icon name="book" size="sm" />
 <span class="hidden sm:inline">{{ t('nav.docs') }}</span>
 </a>

 <!-- 作者：mkx | 日期：2026-04-21 | 变更：新增联系客服按钮，跳转到 QQ 群链接 -->
 <a
 href="https://qm.qq.com/q/iC5bl1PkeQ"
 target="_blank"
 rel="noopener noreferrer"
 class="flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-sm font-medium text-gray-600 transition-colors hover:bg-gray-100 hover:text-claude-text"
 >
 ...
 <div
 v-if="user"
 class="hidden items-center gap-2 rounded-xl border border-primary-100 bg-primary-50/90 px-3 py-1.5 sm:flex"
 >
 <svg
 ...
 class="flex items-center gap-2 rounded-xl p-1.5 transition-colors hover:bg-gray-100"
 ...
 <div v-if="showOnboardingButton" class="border-t border-gray-100 py-1">
