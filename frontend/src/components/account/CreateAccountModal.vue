...
<template>
 ...
 <div class="mt-2 flex rounded-lg bg-gray-100 p-1" data-tour="account-form-platform">
 <button
 type="button"
 ...
 class="mt-3 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-xs text-gray-800"
 >
 ...
 <span
 class="rounded bg-gray-100 px-2 py-0.5 text-[10px] font-semibold text-gray-700"
 >
 推荐个人用户
 </span>
 <span
 class="rounded bg-primary-100 px-2 py-0.5 text-[10px] font-semibold text-primary-700"
 >
 无需 GCP
 </span>
 </div>
 ...
 <div
 v-if="!geminiAIStudioOAuthEnabled"
 class="pointer-events-none absolute right-0 top-full z-50 mt-2 w-80 rounded-md border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-800 opacity-0 shadow-lg transition-opacity group-hover:opacity-100"
 >
 ...
 <div v-if="poolModeEnabled" class="rounded-lg bg-primary-50 p-3">
...
const applyOpenAICompactModelMapping = (credentials: Record<string, unknown>) => {
...
const handleSubmit = async () => {
 ...
 if (form.platform === 'openai') {
 applyOpenAICompactModelMapping(credentials)
 }
