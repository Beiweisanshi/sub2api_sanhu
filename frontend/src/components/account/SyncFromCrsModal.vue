...
<template>
 ...
 >
 <span
 class="inline-block rounded bg-primary-100 px-1.5 py-0.5 text-[10px] font-medium text-primary-700"
 ...
 <span :class="form.sync_proxies ? 'text-primary-600 ' : 'text-gray-400 '">
