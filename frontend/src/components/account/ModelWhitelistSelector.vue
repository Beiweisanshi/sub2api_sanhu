...
<template>
 ...
 <div
 v-if="showDropdown"
 class="absolute left-0 right-0 top-full z-50 mt-1 rounded-lg border border-gray-200 bg-white shadow-lg"
 >
 ...
 type="button"
 @click="fillRelated"
 class="rounded-lg border border-primary-200 px-3 py-1.5 text-sm text-primary-600 hover:bg-primary-50"
 >
