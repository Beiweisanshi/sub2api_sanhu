...
<template>
 ...
 <div class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-primary-500">
 <Icon name="link" size="md" class="text-white" />
 </div>
 <div class="flex-1">
 <h4 class="mb-3 font-semibold text-primary-900">{{ oauthTitle }}</h4>

 <!-- Auth Method Selection -->
 <div v-if="showMethodSelection" class="mb-4">
 <label class="mb-2 block text-sm font-medium text-primary-800">
 {{ methodLabel }}
 </label>
 ...
 <div
 class="rounded-lg border border-primary-300 bg-white/80 p-4"
 >
 ...
 class="rounded-full bg-primary-500 px-2 py-0.5 text-xs text-white"
 >
 ...
 <p class="mb-4 text-sm text-primary-800">
 {{ oauthFollowSteps }}
 </p>
 ...
 <div
 class="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-primary-600 text-xs font-bold text-white"
 >
 1
 </div>
 <div class="flex-1">
 <p class="mb-2 font-medium text-primary-900">
 ...
 class="inline-flex items-center gap-1 text-xs font-normal text-primary-500 hover:text-primary-600"
 >
 ...
 <p
 class="mb-3 text-sm text-primary-700"
 v-text="oauthAuthCodeDesc"
 ></p>
 <div>
 <label class="input-label">
 <Icon name="key" size="sm" class="mr-1 inline text-primary-500" />
 {{ oauthAuthCode }}
 </label>
 <textarea
