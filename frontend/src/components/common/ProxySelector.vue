...
<template>
 ...
 class="inline-flex flex-shrink-0 items-center rounded bg-gray-100 px-1.5 py-0.5 text-xs text-gray-600"
 >
 {{ proxy.account_count }}
 </span>
 <!-- Test result badges -->
 ...
 class="inline-flex flex-shrink-0 items-center gap-1 rounded bg-primary-100 px-1.5 py-0.5 text-xs text-primary-700"
 >
...
.select-trigger-disabled {
 @apply cursor-not-allowed bg-gray-100 opacity-60 ;
}
...
.test-btn {
 ...
 @apply text-gray-400 hover:text-primary-600 ;
 @apply hover:bg-primary-50 ;
 @apply transition-colors disabled:cursor-not-allowed disabled:opacity-50;
}
