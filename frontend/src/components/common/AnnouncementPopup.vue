...
<template>
 ...
 >
 <div
 class="w-full max-w-[680px] overflow-hidden rounded-3xl bg-white shadow-2xl ring-1 ring-black/5"
 @click.stop
 >
 <!-- Header with warm gradient -->
 <div class="relative overflow-hidden border-b border-amber-100/80 bg-gradient-to-br from-amber-50/80 via-orange-50/50 to-yellow-50/30 px-8 py-6">
 <!-- Decorative background -->
 <div class="absolute right-0 top-0 h-full w-64 bg-gradient-to-l from-orange-100/30 to-transparent"></div>
 ...
 <!-- Body -->
 <div class="max-h-[50vh] overflow-y-auto bg-white px-8 py-8">
 <div class="relative">
