...
<template>
 ...
 <span
 v-else
 class="h-3 w-12 animate-pulse rounded bg-gray-200 font-medium"
 ></span>
 <!-- Update indicator -->
 ...
 v-if="dropdownOpen"
 ref="dropdownRef"
 class="absolute left-0 z-50 mt-2 w-64 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-lg"
 >
 ...
 <div
 class="flex items-center gap-3 rounded-lg border border-primary-200 bg-primary-50 p-3"
 >
 <div
 ...
 <!-- Source build hint -->
 <div
 class="flex items-center gap-2 rounded-lg border border-primary-200 bg-primary-50 p-2"
 >
 <svg
 class="h-3.5 w-3.5 flex-shrink-0 text-primary-500"
 fill="none"
 viewBox="0 0 24 24"
 stroke="currentColor"
 stroke-width="2"
 ...
 target="_blank"
 rel="noopener noreferrer"
 class="flex items-center justify-center gap-1 text-xs text-gray-500 transition-colors hover:text-gray-700"
 >
 ...
 target="_blank"
 rel="noopener noreferrer"
 class="flex items-center justify-center gap-2 py-2 text-sm text-gray-500 transition-colors hover:text-gray-700"
 >
 ...
 <span v-else-if="version" class="text-xs text-gray-500">
 v{{ version }}
 </span>
 </div>
</template>
