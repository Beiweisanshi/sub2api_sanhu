...
<template>
 ...
 <button
 @click="toggleTooltip"
 class="flex cursor-pointer items-center gap-2 rounded-xl bg-gray-50 px-3 py-1.5 transition-colors hover:bg-gray-100"
 :title="t('subscriptionProgress.viewDetails')"
 >
 <Icon name="creditCard" size="sm" class="text-gray-600" />
 ...
 <div
 v-if="tooltipOpen"
 class="absolute right-0 z-50 mt-2 w-[340px] overflow-hidden rounded-xl border border-gray-200 bg-white shadow-xl"
 >
 ...
 :key="subscription.id"
 class="border-b border-gray-50 p-3 last:border-b-0"
 >
 ...
 class="flex items-center gap-2 rounded-lg bg-gradient-to-r from-primary-50 to-primary-50 px-2.5 py-1.5"
 >
 ...
 <div class="h-1.5 min-w-0 flex-1 rounded-full bg-gray-200">
 <div
