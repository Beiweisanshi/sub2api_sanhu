...
<template>
 ...
 <div v-for="i in 5" :key="i" class="rounded-lg border border-gray-200 bg-white p-4">
 <div class="space-y-3">
 <div v-for="column in dataColumns" :key="column.key" class="flex justify-between">
 <div class="h-4 w-20 animate-pulse rounded bg-gray-200"></div>
 <div class="h-4 w-32 animate-pulse rounded bg-gray-200"></div>
 </div>
 <div v-if="hasActionsColumn" class="border-t border-gray-200 pt-3">
 ...
 scope="col"
 :class="[
 'sticky-header-cell py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 ',
 ...
 :class="['py-12 text-center text-gray-500 ', getAdaptivePaddingClass()]"
 >
 <slot name="empty">
 <div class="flex flex-col items-center">
 <Icon
