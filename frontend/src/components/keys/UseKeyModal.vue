...
<template>
 ...
 <!-- Client Tabs -->
 <div v-if="clientTabs.length" class="border-b border-gray-200">
 ...
 <!-- OS/Shell Tabs -->
 <div v-if="showShellTabs" class="border-b border-gray-200">
 ...
 <!-- Usage Note -->
 <div v-if="showPlatformNote" class="flex items-start gap-3 p-3 rounded-lg bg-primary-50 border border-primary-100">
