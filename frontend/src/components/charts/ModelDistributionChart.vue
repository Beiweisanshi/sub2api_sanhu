...
<template>
 ...
 >
 <td
 class="max-w-[100px] truncate py-1.5 font-medium text-primary-600 hover:text-primary-800"
 :title="model.model"
 >
...
import { CLAUDE_CHART_PALETTE, CLAUDE_CHART_SERIES } from '@/utils/chartTheme'
