...
<template>
 ...
 :class="group.group_id > 0 ? 'cursor-pointer hover:bg-gray-50 ' : ''"
 @click="group.group_id > 0 && toggleBreakdown('group', group.group_id)"
 >
 <td
 class="max-w-[100px] truncate py-1.5 font-medium"
 :class="group.group_id > 0 ? 'text-primary-600 hover:text-primary-800 ' : 'text-gray-900 '"
 ...
 <td class="py-1.5 text-right text-primary-600">
...
import { CLAUDE_CHART_PALETTE } from '@/utils/chartTheme'
