...
const chartData = computed(() => {
 ...
 backgroundColor: withAlpha(chartColors.value.input, '20'),
 fill: true,
 tension: 0.3
 },
 {
 ...
 backgroundColor: withAlpha(chartColors.value.output, '20'),
 fill: true,
 tension: 0.3
 },
 {
 ...
 backgroundColor: withAlpha(chartColors.value.cacheCreation, '20'),
 fill: true,
 tension: 0.3
 },
 {
 ...
 backgroundColor: withAlpha(chartColors.value.cacheRead, '20'),
 fill: true,
 tension: 0.3
 },
 {
 ...
 backgroundColor: withAlpha(chartColors.value.cacheHitRate, '20'),
 borderDash: [5, 5],
 fill: false,
 tension: 0.3,
 yAxisID: 'yPercent'
