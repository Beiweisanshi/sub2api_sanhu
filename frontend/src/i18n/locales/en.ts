export default {
  ...
  setup: {
    title: 'ZHIMA Setup',
    description: 'Configure your ZHIMA instance',
    database: {
  ...
  admin: {
    ...
    ops: {
      ...
      system: 'System',
      other: 'Other',
      errorsSla: 'Final Request Errors',
      upstreamExcl429529: 'Upstream (incl intermediate)',
      ...
      healthHelp: 'Overall system health score based on final success rate, error rate, and resource usage',
      ...
      diagnosis: {
        ...
        slaCritical: 'Final success rate critically below target ({sla}%)',
        ...
        slaLow: 'Final success rate below target ({sla}%)',
        slaLowImpact: 'Service quality needs attention',
        slaLowAction: 'Analyze final success rate decline causes, optimize system performance',
        ...
        healthLowImpact: 'May indicate minor instability; monitor final success rate and error rates',
      ...
      runtime: {
        ...
        validation: {
          ...
          slaMinPercentRange: 'Final success rate minimum percentage must be between 0 and 100',
      ...
      settings: {
        ...
        slaMinPercent: 'Final Success Rate Minimum Percentage',
        slaMinPercentHint: 'Final success rate below this value will be displayed in red (default: 99.5%)',
      ...
      tooltips: {
        ...
        errorTrend: 'Error counts over time: request errors are final failures only; upstream errors retain intermediate retry/failover failures and exclude 429/529 from the upstream error rate.',
        ...
        sla: 'Final success rate: successful requests / (successful requests + final request errors), excluding business limits such as insufficient balance or quota exceeded. Recovered intermediate upstream errors do not count as failures.',
        errors: 'Error statistics: request errors are final failures, while upstream errors retain intermediate failures for troubleshooting.',
        upstreamErrors: 'Upstream error statistics, including intermediate errors covered by retry/failover; upstream error rate excludes 429/529 rate limits.',
        ...
        health: 'System health score (0-100), considering final success rate, error rate, and resource usage.'
      },
      charts: {
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for ZHIMA end-user login',
      ...
      gatewayForwarding: {
        ...
        envScrub: 'Scrub <env> / paths',
        envScrubHint: 'Rewrite Platform/Shell/OS Version/Working directory lines and $HOME paths inside system[]. Only applies to OAuth fingerprinted requests.',
        systemReminderScrub: 'Scrub <system-reminder>',
        systemReminderScrubHint: 'Rewrite env fields inside <system-reminder>…</system-reminder> blocks in messages[]. Only applies to OAuth fingerprinted requests.',
        billingInject: 'Inject billing header if missing',
        billingInjectHint: 'Prepend a canonical x-anthropic-billing-header block when the request has none (pairs with CCH signing).',
        ccFingerprintV2: 'CC Fingerprint v2',
        ccFingerprintV2Hint: 'Use a SHA256-derived 3-hex suffix for cc_version. When disabled, the upstream cc_version is left untouched (no randomization).',
      },
      webSearchEmulation: {
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to ZHIMA',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">ZHIMA is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of ZHIMA, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to ZHIMA',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the ZHIMA AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
